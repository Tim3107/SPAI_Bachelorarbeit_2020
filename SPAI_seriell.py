...
if __name__ == "__main__":
    ...
    [Matrix_A,M_default,M] = load_Matrix_A(level)
    Matrix_A.tocsc()
    Matrix_A.eliminate_zeros()
    [iterations,duration,M] = Start(Matrix_A,epsilon,max_fillin,case,new_Indices,M_default,M)
    print("Es wurden ",iterations, " Schritte benötigt")
    print("Es wurde ",duration, " Sekunden gerechnet")
    save_data(M,file)
