...
class myThread (threading.Thread):
    ...
    def Start(self,epsilon,max_fillin,case_Abbruchkriterium,Anzahl_neue_Indizes_J_pro_Iteration,M,Default_m,Dimension,i,Database):
        if(case_Abbruchkriterium == 0):                #case 0: nur Epsilon
            self.start_case_0(epsilon,Anzahl_neue_Indizes_J_pro_Iteration,M,Default_m,Dimension,i,Database)   
        elif(case_Abbruchkriterium == 1):                                         #case 1: nur max fill-in
            self.start_case_1(max_fillin,Anzahl_neue_Indizes_J_pro_Iteration,M,Default_m,Dimension,i,Database)
        elif((case_Abbruchkriterium == 2)):                                             #case 2: Epsilon und max fill-in
            self.start_case_2(epsilon,max_fillin,Anzahl_neue_Indizes_J_pro_Iteration,M,Default_m,Dimension,i,Database)               

    def start_case_0(self,epsilon,Anzahl_neue_Indizes_J_pro_Iteration,M,m,Dimension,i,Database):
        Simulation = True
        ...
        while((current_norm_residual > epsilon) and Simulation):                                   
            J_tilde = self.new_Indizes_J_Minimization_problem(Anzahl_neue_Indizes_J_pro_Iteration,current_residual,I,J,residual,Database)                           #beste Kandidaten werden zu J_tilde hinzugefügt
    ...
    def start_case_1(self,max_fillin,Anzahl_neue_Indizes_J_pro_Iteration,M,m,Dimension,i,Database):
        Simulation = True
        J = self.Initialize_J(m)                                                 #Menge J wird erstellt. 
        I = self.Initialize_I(J,i,Dimension,Database)                                                     #Auf Basis der Menge J kann nun auch die Menge I initialisiert werden
        e_i_tilde = self.unit_vector_tilde(i,I)
    ...
    def start_case_2(self,epsilon,max_fillin,Anzahl_neue_Indizes_J_pro_Iteration,M,m,Dimension,i,Database):
        Simulation = True
        J = self.Initialize_J(m)                                                 #Menge J wird erstellt. 
        I = self.Initialize_I(J,i,Dimension,Database)                                                     #Auf Basis der Menge J kann nun auch die Menge I initialisiert werden
        e_i_tilde = self.unit_vector_tilde(i,I)
    ...
    def new_Indizes_J_Minimization_problem(self,Anzahl_neue_Indizes_J_pro_Iteration,current_residual,I,J,residual,Database): #neue Indizes werden über 1-dim Minproblem bestimmt
